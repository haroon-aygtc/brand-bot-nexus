...
import FollowUpQuestionsConfig from "@/pages/admin/admin/FollowUpQuestionsConfig";//import FollowUpQuestionsConfig from "@/components/admin/FollowUpQuestionsConfig";
...
import AdminPageHeader from "@/pages/admin/admin/AdminPageHeader";
