...
export const userApi = {
   ...
   * Get user sessions
   */
  getUserSessions: async (userId: string): Promise<ApiResponse<UserSession[]>> => {
   ...
   */
  getUserPreferences: async (): Promise<ApiResponse<Record<string, string | number | boolean>>> => {
    return api.get<Record<string, string | number | boolean>>("/users/preferences");
  },
  ...
  updateUserPreferences: async (
    ...
    return api.put<Record<string, string | number | boolean>>("/users/preferences", preferences);
  },
};
